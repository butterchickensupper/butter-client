...
describe('OrderReducer', () => {
  ...
  it('called with AddHero action should return a state with the added hero', () => {
    const addedHero = { quantity: 1, item: { name: 'AddedHero', description: 'This is the added hero', price: 1.99, imageUrl: '', available: 5 } };
  ...
  it('called with RemoveHero action should return a state with the correct hero deleted', () => {
    ...
    const expectedState = [{ quantity: 1, item: { name: 'FirstHero', description: 'This is the first hero', available: 10, imageUrl: '', price: 1.99 } }];
